...
@Autonomous(name="RED FOUNDATION", group="Exercises")
//@Disabled
public class AutoGarry_RedSide_Foundation extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        while (opModeIsActive())
        {
            ...
            if(runtime.seconds() > 0.4 && runtime.seconds() < 1.0) {
            ...
            if(runtime.seconds() > 1.0 && runtime.seconds() < 2.4) {
                r.leftDrive.setPower(power - correction);
                r.leftDrive2.setPower(power - correction);
                r.rightDrive.setPower(power + correction);
                r.rightDrive2.setPower(power + correction);
            ...
            if(runtime.seconds() > 2.4 && runtime.seconds() < 3.3) {
            ...
            if(runtime.seconds() > 3.3 && runtime.seconds() < 5.3) {
                r.leftDrive.setPower(-power - correction);
                r.leftDrive2.setPower(-power - correction);
                r.rightDrive.setPower(-power + correction);
                r.rightDrive2.setPower(-power + correction);
            ...
            //Step 5: Let Go
            if(runtime.seconds() > 5.3 && runtime.seconds() < 6.0) {
                r.leftDrive.setPower(0);
                r.leftDrive2.setPower(0);
                r.rightDrive.setPower(0);
                r.rightDrive2.setPower(0);
            ...
            if(runtime.seconds() > 6.0 && runtime.seconds() < 7.0) {
                r.leftDrive.setPower(power - correction);
                r.rightDrive.setPower(-power + correction);
                r.leftDrive2.setPower(-power - correction);
                r.rightDrive2.setPower(power + correction);
            ...
            if(runtime.seconds() > 7.0 && runtime.seconds() < 7.3) {
                r.leftDrive.setPower(0);
                r.leftDrive2.setPower(0);
                r.rightDrive.setPower(0);
                r.rightDrive2.setPower(0);
            ...
            if(runtime.seconds() > 7.3 && runtime.seconds() < 7.5) r.mainArm.setPower(0);

            //Step 8: Move to Bridge Tape
            if(runtime.seconds() > 7.5 && runtime.seconds() < 8.9) {
                r.leftDrive.setPower(power - correction);
                r.rightDrive.setPower(-power + correction);
                r.leftDrive2.setPower(-power - correction);
                r.rightDrive2.setPower(power + correction);
            }
            if(runtime.seconds() > 8.9 && runtime.seconds() < 9.6) {
                r.leftDrive.setPower(-power - correction);
                r.leftDrive2.setPower(-power - correction);
                r.rightDrive.setPower(-power + correction);
                r.rightDrive2.setPower(-power + correction);
            }
            if(runtime.seconds() > 9.6 && runtime.seconds() < 10.0) {
                r.leftDrive.setPower(0);
                r.leftDrive2.setPower(0);
                r.rightDrive.setPower(0);
                r.rightDrive2.setPower(0);
